...
```python
ans = Director.objects.get(id=1)
print('id :', ans.id)
print('name :', ans.name)
print('debut :', ans.debut)
...
```python
ans = Genre.objects.get(title='드라마')
print('id :', ans.id)
...
```python
for i in range(4,13):
    ans = Movie.objects.get(id=i)

    print(ans.director,ans.genre,ans.title,ans.opening_date,ans.running_time,ans.screening,end=' ' )
    print()
...
for i in range(4,13):
    ...
    print(ans.director.name,ans.genre,ans.title,ans.opening_date,ans.running_time,ans.screening,end=' ' )
    print()
...
for i in range(4,13):
    ...
    print(ans.director.name, ans.genre.title ,ans.title,ans.opening_date,ans.running_time,ans.screening,end=' ' )
    print()
```
...
ans = Movie.objects.order_by('opening_date')[0]
...
ans_list = Movie.objects.filter(screening = True).order_by('opening_date')
...
```python
name_instance = Director.objects.get(name='봉준호')
ans_list = Movie.objects.filter(director = name_instance).order_by('opening_date')
...
name_instance = Director.objects.get(name='봉준호')
ans = Movie.objects.filter(director = name_instance).order_by('opening_date')[1]
...
```python
ans_list = Movie.objects.filter(running_time__gt=119).order_by('running_time')
...
ans_list = Movie.objects.filter(running_time__gte=119).order_by('running_time')
...
ans_list = Movie.objects.filter(opening_date__gte='2022-01-01').order_by('opening_date')
...
```python
name_instance = Director.objects.get(name='봉준호')
genre_instance = Genre.objects.get(title='드라마')
ans_list = Movie.objects.filter(director = name_instance, genre = genre_instance ).order_by('opening_date')
for ans in ans_list:
    print(ans.director.name, ans.genre.title ,ans.title,ans.opening_date,ans.running_time,ans.screening,end=' ' )
    print()
...
name_instance = Director.objects.get(name='봉준호')
genre_instance = Genre.objects.get(title='드라마')
ans_list = Movie.objects.exclude(director = name_instance) & Movie.objects.exclude(  genre = genre_instance ).order_by('opening_date')
for ans in ans_list:
    print(ans.director.name, ans.genre.title ,ans.title,ans.opening_date,ans.running_time,ans.screening,end=' ' )
    print()
```